...
put("config", {
    ...
    # ── AI Settings ───────────────────────────────────────────────────────────
    "gemini_api_keys":  "",   # comma-separated Gemini API keys for round-robin
    "game_55club_image": "",  # optional custom banner image URL for 55 Club card
...
nodes = {
    ...
    "ai_stats":         {"totals": {"total_predictions":0,"total_wins":0,"total_losses":0}},
    "ai_user_stats":    {"_init": True},
    "ai_predictions":   {"_init": True},
}
...
print("  5b. Add Gemini API keys (comma-separated) in Settings -> Gemini API Keys")
